...
class ActionModule(ActionBase):
    def run(self, tmp=None, task_vars=None):
      ...
      task_vars['vhost']['SSLCertificateFile'] = self._task.args.get('SSLCertificateFile', None)
      task_vars['vhost']['SSLCertificateKeyFile'] = self._task.args.get('SSLCertificateKeyFile', None)
      task_vars['vhost']['SSLCertificateChainFile'] = self._task.args.get('SSLCertificateChainFile', None)
...
class WrapSymlink(BaseWrap):
  ...
  def run(self, task_vars):
      ...
      module_return = self.action._execute_module(module_name='file', module_args=new_module_args, task_vars=task_vars)
